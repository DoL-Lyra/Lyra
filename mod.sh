...
URL_AU_F="https://github.com/DoL-Lyra/assets/releases/download/assets/AUfemale.imgpack_v0.7.3.zip"
URL_AU_M="https://github.com/DoL-Lyra/assets/releases/download/assets/AUmale.imgpack_v0.3.2.zip"
